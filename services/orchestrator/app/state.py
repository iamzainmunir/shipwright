...
class Store(Protocol):
    ...
    # Project registry (multi-project). See app/store.py / app/pgstore.py for the concrete impls.
    async def list_projects(self, workspace_id: str = ...) -> list: ...
    async def get_project(self, id_or_path: str, workspace_id: str = ...): ...
    async def create_project(self, project): ...
    async def upsert_built_project(self, workspace_id: str, name: str, path: str): ...
    async def delete_project(self, project_id: str, workspace_id: str = ...) -> None: ...
    async def touch_project(self, path: str, workspace_id: str = ...) -> None: ...
